export const environment = {
  ...
  //Production
  // imageURL: 'https://s3-us-west-1.amazonaws.com/content.toolots.com/catalog/product',
  // fileURL: 'https://s3-us-west-1.amazonaws.com/content.toolots.com/attachment/file',
  
  imageURL: 'https://content.toolots.net/media/catalog/product',
  fileURL: 'https://content.toolots.net/media/attachment/file',
  linkURL: 'https://www.toolots.com',
  previewURL: 'https://www.toolots.com/index.php/catalog/product/view/id/',
  siteURL: 'https://merchantportal.toolots.com/',
