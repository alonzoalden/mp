...
export class UploadUpdateVendorAttachmentSuccess implements Action {
    readonly type =
        CompanyAttachmentActionTypes.UploadUpdateVendorAttachmentSuccess;

    constructor(public payload: VendorAttachment) {}
}
export class UploadUpdateVendorAttachmentFail implements Action {
    readonly type =
        CompanyAttachmentActionTypes.UploadUpdateVendorAttachmentFail;

    constructor(public payload: string) {}
}

// Union the valid types
export type CompanyAttachmentActions =
