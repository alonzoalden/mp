...
export enum ItemActionTypes {
    ...
    LoadItemAll = '[Item] Load Item All',
...
export class LoadItemAll implements Action {
    readonly type = ItemActionTypes.LoadItemAll;
    constructor(public payload: number) {}
}
...
export class EditItemBatchSuccess implements Action {
    ...
    constructor(
        public payload: { itembatch: ItemBatch[]; updateditems: ItemBatch[] }
    ) {}
}
...
export class DownloadItemLabelCount implements Action {
    ...
    constructor(
        public payload: { item: Item; count: number; border: string }
    ) {}
}
