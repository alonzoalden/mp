...
export class ItemListComponent implements OnInit, OnChanges {
    ...
    displayedColumns = ['Menu', 'ItemID', 'MerchantID', 'ProductDetails', 'FulfilledBy', 'Price', 'SpecialPrice', 'SpecialFrom', 'SpecialTo', 'Quantity', 'MerchantQuantity', 'Approval', 'Visibility', 'UpdatedOn'];
