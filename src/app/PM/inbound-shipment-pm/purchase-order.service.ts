...
export class PurchaseOrderService {
    ...
    getPurchaseOrderAllVendorOverview(): Observable<PurchaseOrder[]> {
        // if (this.purchaseorders) {
        //     return of(this.purchaseorders);
        // }
        return this.http.get<PurchaseOrder[]>(this.apiURL + '/purchaseorder/allvendoroverview')
            .pipe(
                //tap(data => console.log(JSON.stringify(data))),
                tap(data => this.purchaseorders = data),
                catchError(this.handleError)
    ...
    getCurrentPurchaseOrderEdit(id: number): Observable<PurchaseOrder> {
        ...
        return this.getPurchaseOrderAll(id);
    }
