...
export enum SettingActionTypes {
    ...
    LoadAllSubMemberVendors = '[Admin] Load All Sub Member Vendors',
...
export class LoadAllSubMemberVendors implements Action {
    readonly type = SettingActionTypes.LoadAllSubMemberVendors;
}
